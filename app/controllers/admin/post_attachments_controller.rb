class Admin::PostAttachmentsController < Admin::AdminController
  ...
  def create
    ...
    respond_to do |format|
      if @post_attachment.save
        format.html { redirect_to [:admin, @post_attachment], notice: 'Post attachment was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @post_attachment.update(post_attachment_params)
        format.html { redirect_to [:admin, @post_attachment], notice: 'Post attachment was successfully updated.' }
  ...
  private
    ...
    def post_attachment_params
      params.require(:post_attachment).permit(:post_id, :post_carouselimage, :post_carouselcontent)
    end
end
