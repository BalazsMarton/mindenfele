...
class PostAttachmentsControllerTest < ActionController::TestCase
  ...
  test "should create post_attachment" do
    assert_difference('PostAttachment.count') do
      post :create, post_attachment: { post_carouselcontent: @post_attachment.post_carouselcontent, post_carouselimage: @post_attachment.post_carouselimage, post_id: @post_attachment.post_id }
    end
  ...
  test "should update post_attachment" do
    patch :update, id: @post_attachment, post_attachment: { post_carouselcontent: @post_attachment.post_carouselcontent, post_carouselimage: @post_attachment.post_carouselimage, post_id: @post_attachment.post_id }
    assert_redirected_to post_attachment_path(assigns(:post_attachment))
  end
